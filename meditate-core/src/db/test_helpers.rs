...
use super::{Database, Event, SessionMode};
...
/// Mark every pending event synced. Many event-emission tests need
/// to "reset the event log" between assertions — emit something,
